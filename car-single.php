...
<section class="ftco-section ftco-car-details">
    <div class="container">
        ...
        if (isset($_GET['car_id'])) {
            ...
            $sql = "SELECT * FROM cabregistration WHERE id = '$car_id'";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="car-details">
                                ...
                                <?php echo '<img src="uploads/' . $row['photo'] . '" alt="image" width="500" height="500" class="w-100">'; ?>
                                </div>
                                <div class="text text-center">
                                    <span class="subheading"></span>
                                    <h2> <?php echo $row['cabmodel']; ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="text">
                                            <h3 class="heading mb-0 pl-3">
                                                Mileage
                                                <span><?php echo $row['currentmilage']; ?></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="text">
                                            <h3 class="heading mb-0 pl-3">
                                                ...
                                                <span><?php echo $row['yearofmanufacture']; ?></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media-body py-md-4">
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="text">
                                            <h3 class="heading mb-0 pl-3">
                                                Car Per KM
                                                <span><?php echo $row['cabfare']; ?></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media-body py-md-4">
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="text">
                                            <h3 class="heading mb-0 pl-3">
                                                Car Rental Fee
                                                <span><?php echo $row['carrentalfee']; ?></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media-body py-md-4">
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="text">
                                            <h3 class="heading mb-0 pl-3">
                                                Fuel
                                                <span><?php echo $row['carfueltype']; ?></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
